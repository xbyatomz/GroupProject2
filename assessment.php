<?php
$title = 'WUC | Assessment';
require 'head.php';

echo
'             <div class="Container">
                <div class="title">
                    <h1>Your Course: Software Engineering</h1>
                </div>
